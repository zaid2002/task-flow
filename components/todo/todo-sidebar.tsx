...
function SidebarCategories({ activeCategory, onCategoryChange, counts }: SidebarCategoriesProps) {
  return (
...
function SidebarTags({ activeCategory, onCategoryChange }: SidebarTagsProps) {
  return (
    <div className="mt-8">
...
export function DesktopSidebarContent({ activeCategory, onCategoryChange, counts }: DesktopSidebarContentProps) {
  return (
...
export function MobileSidebarContent({ activeCategory, onCategoryChange }: MobileSidebarContentProps) {
  return (
    <div className="flex flex-col h-full">
      <SidebarTags
        activeCategory={activeCategory}
